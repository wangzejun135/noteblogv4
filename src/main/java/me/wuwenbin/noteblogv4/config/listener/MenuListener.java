...
>>>>>>> fcd3c059bcf0142a8234a8091b634aea80b4fdf5
    ...
    @Autowired
    public MenuListener(MenuRepository menuRepository, RoleRepository roleRepository, ParamRepository paramRepository,
        ResourceRepository resourceRepository, Environment environment)
    {
    ...
    public void onApplicationEvent(ApplicationReadyEvent event)
    {
        ...
        else if (nbParam.getValue().equals(INIT_NOT) && cnt == 1 && rootCnt == 1)
        {
            ...
            Object[][] folderMenus = new Object[][] {
                {"权限管理", "layui-icon layui-icon-auz",
                    new String[][] {{"/management/menu", "菜单管理", "fa fa-list-ul"},
                        {"/management/role", "角色管理", "fa fa-user-o"}, {"/management/users", "用户管理", "fa fa-users"}}},
                {"内容发布", "layui-icon layui-icon-edit",
                    new String[][] {{"/management/article/post", "发布文章", "fa fa-send-o"},
                        {"/management/note/post", "随记随笔", "fa fa-file-text-o"}}},
                {"内容管理", "layui-icon layui-icon-template-1",
                    new String[][] {{"/management/article", "文章管理", "fa fa-newspaper-o"},
                        {"/management/note", "随笔管理", "fa fa-file-o"}}},
                {"字典管理", "layui-icon layui-icon-read",
                    new String[][] {{"/management/dictionary/cate", "分类管理", "fa fa-clone"},
                ...
                {"偏好设置", "layui-icon layui-icon-set",
                    new String[][] {{"/management/settings/qrcode", "二维码设置", "fa fa-qrcode"},
                ...
                {"个人内容", "layui-icon layui-icon-diamond",
                    new String[][] {{"/management/profile", "关于内容", "fa fa-hdd-o"},
                        {"/management/project", "资源项目分享", "fa fa-laptop"},
                        {"/management/cloudFile", "云文件分享", "fa fa-file-archive-o"}}},
                {"消息管理", "layui-icon layui-icon-username",
                    new String[][] {{"/management/comment", "评论管理", "fa fa-comments-o"},
     ...
     * @return
     */
    private NBSysMenu fixMenu(String icon, String name, int orderIndex, long parentId, long roleId, MenuType type)
    {
    ...
    {
        String[] menus = new String[] {"/management/menu", "/management/role", "/management/users"};
